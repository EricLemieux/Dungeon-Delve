...
class SpeechToTextService(private val client: ElevenLabsClient) {
     ...
     */
    suspend fun recognizeSpeech(audioData: ByteArray, modelId: String = "eleven_multilingual_v1"): SpeechToTextResponse {
     ...
     * @throws NotImplementedError as this is a stub implementation
     */
    suspend fun recognizeSpeechFromFile(filePath: String, modelId: String = "eleven_multilingual_v1"): SpeechToTextResponse {
