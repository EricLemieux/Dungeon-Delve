...
class ElevenLabsAPI(apiKey: String) {
     ...
     */
    suspend fun speechToText(audioData: ByteArray, modelId: String = "eleven_multilingual_v1"): SpeechToTextResponse {
     ...
     * @throws NotImplementedError as this is a stub implementation
     */
    suspend fun speechToTextFromFile(filePath: String, modelId: String = "eleven_multilingual_v1"): SpeechToTextResponse {
    ...
    companion object {
        ...
        fun fromEnvironment(): ElevenLabsAPI {
            val apiKey = System.getenv("ELEVEN_LABS_API_KEY") 
